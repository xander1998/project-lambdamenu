...
const std::vector<std::string> CAPTIONS_ATTACH_SMG{ "Extended Magazine", "Drum Magazine", "Scope", "Suppressor", "Flashlight", "Yusuf Amir Luxury Finish" };
const std::vector<std::string> VALUES_ATTACH_SMG{ "COMPONENT_SMG_CLIP_02", "COMPONENT_SMG_CLIP_03", "COMPONENT_AT_SCOPE_MACRO_02", "COMPONENT_AT_PI_SUPP", "COMPONENT_AT_AR_FLSH", "COMPONENT_SMG_VARMOD_LUXE" };
...
//Rifles
const std::vector<std::string> CAPTIONS_ATTACH_ASSAULTRIFLE{ "Extended Magazine", "Drum Magazine", "Scope", "Suppressor", "Grip", "Flashlight", "Yusuf Amir Luxury Finish" };
const std::vector<std::string> VALUES_ATTACH_ASSAULTRIFLE{ "COMPONENT_ASSAULTRIFLE_CLIP_02", "COMPONENT_ASSAULTRIFLE_CLIP_03", "COMPONENT_AT_SCOPE_MACRO", "COMPONENT_AT_AR_SUPP_02", "COMPONENT_AT_AR_AFGRIP", "COMPONENT_AT_AR_FLSH", "COMPONENT_ASSAULTRIFLE_VARMOD_LUXE" };

const std::vector<std::string> CAPTIONS_ATTACH_CARBINERIFLE{ "Extended Magazine", "Box Magazine", "Scope", "Suppressor", "Grip", "Flashlight", "Rail Cover", "Yusuf Amir Luxury Finish" }; //rail cover? idk
const std::vector<std::string> VALUES_ATTACH_CARBINERIFLE{ "COMPONENT_CARBINERIFLE_CLIP_02", "COMPONENT_CARBINERIFLE_CLIP_03", "COMPONENT_AT_SCOPE_MEDIUM", "COMPONENT_AT_AR_SUPP", "COMPONENT_AT_AR_AFGRIP", "COMPONENT_AT_AR_FLSH", "COMPONENT_AT_RAILCOVER_01", "COMPONENT_CARBINERIFLE_VARMOD_LUXE" };
...
//Shotguns
const std::vector<std::string> CAPTIONS_ATTACH_SAWNOFFSHOTGUN{ "Gilded Gun Metal Finish" };
const std::vector<std::string> VALUES_ATTACH_SAWNOFFSHOTGUN{ "COMPONENT_SAWNOFFSHOTGUN_VARMOD_LUXE" };
...
const std::vector<std::string> CAPTIONS_ATTACH_ASSAULTSHOTGUN{ "Extended Magazine", "Suppressor", "Grip", "Flashlight" };
const std::vector<std::string> VALUES_ATTACH_ASSAULTSHOTGUN{ "COMPONENT_ASSAULTSHOTGUN_CLIP_02", "COMPONENT_AT_AR_SUPP", "COMPONENT_AT_AR_AFGRIP", "COMPONENT_AT_AR_FLSH" };
...
const std::vector<std::string> CAPTIONS_ATTACH_SPECIALCARBINE{ "Extended Magazine", "Beta C-Magazine", "Flashlight", "Scope", "Suppressor", "Grip" };
const std::vector<std::string> VALUES_ATTACH_SPECIALCARBINE{ "COMPONENT_SPECIALCARBINE_CLIP_02", "COMPONENT_SPECIALCARBINE_CLIP_03", "COMPONENT_AT_AR_FLSH", "COMPONENT_AT_SCOPE_MEDIUM", "COMPONENT_AT_AR_SUPP_02", "COMPONENT_AT_AR_AFGRIP" };

const std::vector<std::string> CAPTIONS_ATTACH_COMBATPDW{ "Extended Magazine", "Drum Magazine", "Flashlight", "Scope", "Grip" };
const std::vector<std::string> VALUES_ATTACH_COMBATPDW{ "COMPONENT_COMBATPDW_CLIP_02", "COMPONENT_COMBATPDW_CLIP_03", "COMPONENT_AT_AR_FLSH", "COMPONENT_AT_SCOPE_SMALL", "COMPONENT_AT_AR_AFGRIP" };
...
const std::vector<std::string> CAPTIONS_ATTACH_SWITCHBLADE{ "Variation 1", "Variation 2" };
const std::vector<std::string> VALUES_ATTACH_SWITCHBLADE{ "COMPONENT_SWITCHBLADE_VARMOD_VAR1", "COMPONENT_SWITCHBLADE_VARMOD_VAR2" };

const std::vector<std::string> CAPTIONS_ATTACH_REVOLVER{ "Variation 1", "Variation 2" };
