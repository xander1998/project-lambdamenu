...
//constexpr const char* CAPTIONS_ATTACH_MINISMG[] = { "", "" };
//constexpr const char* VALUES_ATTACH_MINISMG[] = { "", "" }; //Finishing Later, core is a little bit more worthy
...
constexpr size_t VOV_WEAPONMOD_SIZES[] = {
	...
	//std::extent<decltype(CAPTIONS_ATTACH_MINISMG)>::value,
};
