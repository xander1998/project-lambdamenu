...
const std::vector<std::string> VALUES_COMPACTS{ "ISSI3", "ISSI4", "ISSI5", "ISSI6", "PANTO", "PRAIRIE", "RHAPSODY", "BLISTA", "BRIOSO", "DILETTANTE", "DILETTANTE2", "ISSI2" };

const std::vector<std::string> VALUES_SUVS{ "NOVAK", "TOROS", "PATRIOT2", "CAVALCADE", "CAVALCADE2", "DUBSTA", "DUBSTA2", "SERRANO", "GRESLEY", "MESA", "MESA2", "SEMINOLE", "GRANGER", "LANDSTALKER", "HABANERO", "HUNTLEY", "FQ2", "BALLER", "BALLER2", "BJXL", "PATRIOT", "ROCOTO", "CONTENDER", "RADI" };

const std::vector<std::string> VALUES_OFFROAD{ "CARACARA2", "HELLION", "RCBANDITO", "MONSTER3", "MONSTER4", "MONSTER5", "BRUISER", "BRUISER2", "BRUISER3", "BRUTUS", "BRUTUS2", "BRUTUS3", "MENACER", "FREECRAWLER", "CARACARA", "RIATA", "KAMACHO", "TECHNICAL3", "NIGHTSHARK", "INSURGENT3", "DUNE3", "BLAZER5", "TECHNICAL2", "DUNE4", "DUNE5", "DUBSTA3", "BIFTA", "BFINJECTION", "DUNE", "DLOADER", "DUNE2", "BODHI2", "KALAHARI", "MESA3", "MARSHALL", "BRAWLER", "RANCHERXL", "RANCHERXL2", "INSURGENT2", "INSURGENT", "REBEL2", "REBEL", "TECHNICAL", "BLAZER", "BLAZER3", "BLAZER2", "BLAZER4", "TROPHYTRUCK2", "GUARDIAN", "MONSTER", "SANDKING2", "SANDKING", "TROPHYTRUCK" };
...
const std::vector<std::string> VOV_CAR_CAPTIONS[] = { CAPTIONS_SUPERCARS, CAPTIONS_SPORTS, CAPTIONS_SPORTCLASSICS, CAPTIONS_MUSCLE, CAPTIONS_LOWRIDERS, CAPTIONS_COUPES, CAPTIONS_SEDANS, CAPTIONS_COMPACTS, CAPTIONS_SUVS, CAPTIONS_OFFROAD, CAPTIONS_VIP };

const std::vector<std::string> VOV_CAR_VALUES[] = { VALUES_SUPERCARS, VALUES_SPORTS, VALUES_SPORTCLASSICS, VALUES_MUSCLE, VALUES_LOWRIDERS, VALUES_COUPES, VALUES_SEDANS, VALUES_COMPACTS, VALUES_SUVS, VALUES_OFFROAD, VALUES_VIP };
...
const std::vector<std::string> VALUES_EMERGENCY{ "SCARAB", "SCARAB2", "SCARAB3", "TERBYTE", "THRUSTER", "RIOT2", "KHANJALI", "CHERNOBOG", "BARRAGE", "APC", "HALFTRACK", "POLICEOLD2", "AMBULANCE", "BARRACKS", "BARRACKS2", "FBI", "RIOT", "CRUSADER", "FBI2", "LGUARD", "PRANGER", "POLICEOLD1", "POLICET", "SHERIFF2", "FIRETRUK", "PBUS", "RHINO", "POLICE2", "POLICE", "POLICE3", "SHERIFF", "POLICE4", "POLICEB" };

const std::vector<std::string> VALUES_MOTORCYCLES{ "RROCKET", "DEATHBIKE", "DEATHBIKE2", "DEATHBIKE3", "OPPRESSOR2", "AKUMA", "DOUBLE", "ENDURO", "THRUST", "VINDICATOR", "AVARUS", "HEXER", "INNOVATION", "SANCTUS", "MANCHEZ", "SANCHEZ2", "SANCHEZ", "BF400", "CARBONRS", "CHIMERA", "SHOTARO", "BATI", "BATI2", "ESSKEY", "FAGGIO3", "FAGGIO", "RUFFIAN", "VORTEX", "LECTRO", "NEMESIS", "FAGGIO2", "DEFILER", "HAKUCHOU", "HAKUCHOU2", "PCJ", "VADER", "BAGGER", "CLIFFHANGER", "DAEMON", "DAEMON2", "GARGOYLE", "NIGHTBLADE", "RATBIKE", "SOVEREIGN", "WOLFSBANE", "ZOMBIEA", "ZOMBIEB" };
...
bool onconfirm_veh_menu(MenuItem<int> choice)
{
		...
		if (featureDriftMode)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0)){
				...
				if (ENTITY::DOES_ENTITY_EXIST(veh) && !ENTITY::IS_ENTITY_DEAD(veh)){
					if (ENTITY::DOES_ENTITY_EXIST(driver)){
						if (driver == playerPed){
							set_status_text("Drift Mode ~g~ENABLED.~n~~s~Hold <C><FONT COLOR='" + menuColor_HEX + "'>SHIFT</C> ~s~To Drift.");
						}
					}
				}
	...
	case 16:
		if (featureVehControls)
		{
			...
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>LEFT ~s~& <FONT COLOR='" + menuColor_HEX + "'>RIGHT ~s~Arrows control turn signals ~s~");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>UP ~s~& <FONT COLOR='" + menuColor_HEX + "'>DOWN ~s~Arrows control front windows");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL + UP ~s~& <FONT COLOR='" + menuColor_HEX + "'>DOWN ~s~Arrows controls back windows");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>NUMPAD DECIMAL ~s~Key controls interior light");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>NUMPAD PLUS ~s~Key toggles police lights");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>NUMPAD MINUS ~s~Key toggles police siren");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD7 ~s~Key toggles Front Left Door ");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD9 ~s~Key toggles Front Right Door");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD4 ~s~Key toggles Back Left Door");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD6 ~s~Key toggles Back Right Door");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD8 ~s~Key toggles Hood");
			set_status_text("<FONT COLOR='" + menuColor_HEX + "'>CTRL+NUMPAD5 ~s~Key toggles Trunk");
		}
		else
		{
	...
	if (featureKPH)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0))
		{
			if (PED::IS_PED_IN_FLYING_VEHICLE(playerPed) || PED::IS_PED_IN_ANY_BOAT(playerPed) || PED::IS_PED_IN_ANY_SUB(playerPed))
			{
				...
				char speed_text[50];
				snprintf(speed_text, 50, (char*)("kn<FONT COLOR='" + menuColor_HEX + "'>/~s~kt").c_str());
	...
	if (featureKPHMPH)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0))
		{
			...
			else
			{
				...
				snprintf(speedKph_text, 50, (char*)("<FONT COLOR='" + menuColor_HEX + "'>%.0f").c_str(), speedKph);
				snprintf(speedMph_text, 50, "%.0f", speedMph);
				...
				snprintf(kphspeed_text, 50, (char*)("<FONT COLOR='" + menuColor_HEX + "'>KPH").c_str());
