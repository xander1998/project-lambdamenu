...
const std::vector<std::string> CAPTIONS_SEDANS{ "Enus Stafford", "Albany Emperor", "Albany Emperor (Rusty)", "Albany Emperor (Snow)", "Albany Primo", "Albany Washington", "Benefactor Glendale", "Benefactor Schafter", "Chariot Romero Hearse", "Cheval Fugitive", "Cheval Surge", "Declasse Asea", "Declasse Asea (Snow)", "Declasse Premier", "Dundreary Regina", "Dundreary Stretch", "Enus Super Diamond", "Karin Asterope", "Karin Intruder", "Obey Tailgater", "Ubermacht Oracle", "Ubermacht Oracle Mk2", "Vapid Stanier", "Vapid Stanier (Taxi)", "Vulcar Ingot", "Vulcar Warrener", "Zirconium Stratum" };

const std::vector<std::string> VALUES_SEDANS{ "STAFFORD", "EMPEROR", "EMPEROR2", "EMPEROR3", "PRIMO", "WASHINGTON", "GLENDALE", "SCHAFTER2", "ROMERO", "FUGITIVE", "SURGE", "ASEA", "ASEA2", "PREMIER", "REGINA", "STRETCH", "SUPERD", "ASTEROPE", "INTRUDER", "TAILGATER", "ORACLE", "ORACLE2", "STANIER", "TAXI", "INGOT", "WARRENER", "STRATUM" };


const std::vector<std::string> CAPTIONS_COMPACTS{ "Dinka Blista Kanjo", "Maxwell Asbo", "Weeny Issi Classic", "Apocalypse Issi", "Future Shock Issi", "Nightmare Issi", "Benefactor Panto", "Bollokan Prairie", "Declasse Rhapsody", "Dinka Blista", "Grotti Brioso R/A", "Karin Dilettante", "Karin Dilettante (FlyUS)", "Weeny Issi" };

const std::vector<std::string> VALUES_COMPACTS{ "KANJO", "ASBO", "ISSI3", "ISSI4", "ISSI5", "ISSI6", "PANTO", "PRAIRIE", "RHAPSODY", "BLISTA", "BRIOSO", "DILETTANTE", "DILETTANTE2", "ISSI2" };

const std::vector<std::string> CAPTIONS_SUVS{ "Ubermacht Rebla GTS", "Lampadati Novak", "Pegassi Toros", "Mammoth Patriot Stretch", "Albany Cavalcade", "Albany Cavalcade Mk2", "Benefactor Dubsta", "Benefactor Dubsta (Flat Black)", "Benefactor Serrano", "Bravado Gresley", "Canis Mesa", "Canis Mesa (Snow)", "Canis Seminole", "Declasse Granger", "Dundreary Landstalker", "Emperor Habanero", "Enus Huntley S", "Fathom FQ 2", "Gallivanter Baller (Large)", "Gallivanter Baller (Small)", "Karin BeeJay XL", "Mammoth Patriot", "Obey Rocoto", "Vapid Contender", "Vapid Radius" };

const std::vector<std::string> VALUES_SUVS{ "REBLA", "NOVAK", "TOROS", "PATRIOT2", "CAVALCADE", "CAVALCADE2", "DUBSTA", "DUBSTA2", "SERRANO", "GRESLEY", "MESA", "MESA2", "SEMINOLE", "GRANGER", "LANDSTALKER", "HABANERO", "HUNTLEY", "FQ2", "BALLER", "BALLER2", "BJXL", "PATRIOT", "ROCOTO", "CONTENDER", "RADI" };

const std::vector<std::string> CAPTIONS_OFFROAD{ "Nagasaki Outlaw", "RUNE Zhaba", "Maxwell Vagrant", "Karin Everon", "Vapid Caracara 4X4", "Annis Hellion", "RC Bandito", "Apocalypse Sasquatch", "Future Shock Sasquatch", "Nightmare Sasquatch", "Apocalypse Bruiser", "Future Shock Bruiser", "Nightmare Bruiser", "Apocalypse Brutus", "Future Shock Brutus", "Nightmare Brutus", "HVY Menacer", "Canis Freecrawler", "Vapid Caracara", "Vapid Riata", "Canis Kamacho", "Karin Technical Custom", "HVY Nightshark", "HVY Insurgent Pickup Custom", "Dune FAV", "Aqua Blazer", "Aqua Technical", "Ramp Buggy Spoiler", "Ramp Buggy No Spoiler", "Benefactor Dubsta 6x6", "BF Bifta", "BF Injection", "Bravado Dune", "Bravado Duneloader", "Bravado Space Docker", "Canis Bodhi", "Canis Kalahari", "Canis Mesa (Off-Road)", "Cheval Marshall", "Coil Brawler", "Declasse Rancher XL", "Declasse Rancher XL (Snow)", "Insurgent", "Insurgent (Gun Mount)", "Karin Rebel", "Karin Rebel (Rusty)", "Karin Technical", "Nagasaki Blazer", "Nagasaki Blazer (Hot Rod)", "Nagasaki Blazer (Lifeguard)", "Nagasaki Blazer (Street)", "Vapid Desert Raid", "Vapid Guardian", "Vapid Liberator", "Vapid Sandking", "Vapid Sandking XL", "Vapid Trophy Truck" };

const std::vector<std::string> VALUES_OFFROAD{ "OUTLAW", "ZHABA", "VAGRANT", "EVERON", "CARACARA2", "HELLION", "RCBANDITO", "MONSTER3", "MONSTER4", "MONSTER5", "BRUISER", "BRUISER2", "BRUISER3", "BRUTUS", "BRUTUS2", "BRUTUS3", "MENACER", "FREECRAWLER", "CARACARA", "RIATA", "KAMACHO", "TECHNICAL3", "NIGHTSHARK", "INSURGENT3", "DUNE3", "BLAZER5", "TECHNICAL2", "DUNE4", "DUNE5", "DUBSTA3", "BIFTA", "BFINJECTION", "DUNE", "DLOADER", "DUNE2", "BODHI2", "KALAHARI", "MESA3", "MARSHALL", "BRAWLER", "RANCHERXL", "RANCHERXL2", "INSURGENT2", "INSURGENT", "REBEL2", "REBEL", "TECHNICAL", "BLAZER", "BLAZER3", "BLAZER2", "BLAZER4", "TROPHYTRUCK2", "GUARDIAN", "MONSTER", "SANDKING2", "SANDKING", "TROPHYTRUCK" };
...
const std::vector<std::string> VALUES_VANS{ "SPEEDO4", "BOXVILLE5", "SURFER", "SURFER2", "PARADISE", "RUMPO3", "RUMPO2", "RUMPO", "YOUGA", "YOUGA2", "CAMPER", "PONY", "PONY2", "TACO", "BURRITO3", "BURRITO2", "BURRITO4", "GBURRITO2", "BURRITO", "BURRITO5", "GBURRITO", "MOONBEAM", "MINIVAN", "SPEEDO", "SPEEDO2", "JOURNEY" };
