...
const std::vector<std::string> MENU_VEHICLE_CATEGORIES{ "Cars", "Industrial", "Emergency and Military", "Motorcycles", "Planes", "Helicopters", "Boats", "Bicycles", "Spawn Vehicle By Name" };

//Cars

const std::vector<std::string> MENU_CAR_CATEGORIES{ "Open Wheel", "Supercars", "Sports", "Sport Classics", "Muscle", "Lowriders", "Coupes", "Sedans", "Compacts", "SUVs", "Offroad", "VIP" };

const std::vector<std::string> CAPTIONS_OPENWHEELS{ "Benefactor BR8", "Declasse DR1", "Progen PR4", "Ocelot R88" };

const std::vector<std::string> VALUES_OPENWHEELS{ "OPENWHEEL1", "OPENWHEEL2", "FORMULA", "FORMULA2" };

const std::vector<std::string> CAPTIONS_SUPERCARS{ "Lampadati Tigon", "Grotti Furia", "Annis S80RR", "Truffade Thrax", "Benefactor Krieger", "Pegassi Zorrusso", "Progen Emerus", "Principe Deveste Eight", "Declasse Scramjet", "Overflod Tyrant", "Pegassi Tezeract", "Cheval Taipan", "Overflod Entity XXR", "Ubermacht SC1", "Overflod Autarch", "Coil Cyclone", "Grotti Visione", "Grotti Vigilante", "Dewbauchee Vagner", "Ocelot XA-21", "Progen GP1", "Progen Itali GTB", "Progen Itali GTB Custom", "Truffade Nero", "Truffade Nero Custom", "Pegassi Tempesta", "Ocelot Penetrator", "Rocket Voltic", "Annis RE-7B", "Bravado Banshee 900R", "Coil Voltic", "Emperor ETR1", "Grotti Cheetah", "Grotti X80 Proto", "Grotti Turismo R", "Karin Sultan RS", "Overflod Entity XF", "Pegassi Infernus", "Pegassi Osiris", "Pegassi Reaper", "Pegassi Vacca", "Pegassi Zentorno", "Pfister 811", "Progen T20", "Progen Tyrus", "Truffade Adder", "Vapid Bullet", "Vapid FMJ" };

const std::vector<std::string> VALUES_SUPERCARS{ "TIGON", "FURIA", "S80", "THRAX", "KRIEGER", "ZORRUSSO", "EMERUS", "DEVESTE", "SCRAMJET", "TYRANT", "TEZERACT", "TAIPAN", "ENTITY2", "SC1", "AUTARCH", "CYCLONE", "VISIONE", "VIGILANTE", "VAGNER", "XA21", "GP1", "ITALIGTB", "ITALIGTB2", "NERO", "NERO2", "TEMPESTA", "PENETRATOR", "VOLTIC2", "LE7B", "BANSHEE2", "VOLTIC", "SHEAVA", "CHEETAH", "PROTOTIPO", "TURISMOR", "SULTANRS", "ENTITYXF", "INFERNUS", "OSIRIS", "REAPER", "VACCA", "ZENTORNO", "PFISTER811", "T20", "TYRUS", "ADDER", "BULLET", "FMJ" };

const std::vector<std::string> CAPTIONS_SPORTS{ "Maibatsu Penumbra FF", "Invetero Coquette D10", "Dinka Sugoi", "Albany V-STR", "Karin Sultan Classic", "Overflod Imorgon", "Lampadati Komoda", "Enus Paragon R", "Enus Paragon R (Armored)", "Obey 8F Drafter", "Weeny Issi Sport", "Vysser Neo", "Ocelot Jugular", "Ocelot Locust", "Benefactor Schlagen GT", "Grotti Itali GTO", "Apocalypse ZR380", "Future Shock ZR380", "Nightmare ZR380", "Dinka Jester Classic", "Declasse Hotring Sabre", "Vapid GB200", "Vapid Flash GT", "Ubermacht Sentinel Classic", "Benefactor Streiter", "Ubermacht Revolter", "Coil Raiden", "Ocelet Pariah", "Pfister Neon", "Pfister Comet SR", "Pfister Comet Safari", "Hijak Ruston", "Dewbauchee Spectre", "Dewbauchee Spectre Custom", "Pfister Comet Retro Custom", "Albany Alpha", "Annis Elegy RH8", "Elegy Retro Custom", "Benefactor Feltzer", "Benefactor Schwartzer", "Benefactor Surano", "BF Raptor", "Bravado Banshee", "Bravado Buffalo", "Bravado Buffalo S", "Bravado Buffalo S (Race)", "Bravado Verlierer", "Declasse Drift Tampa", "Dewbauchee Massacro", "Dewbauchee Massacro (Race)", "Dewbauchee Rapid GT", "Dewbauchee Rapid GT Cabrio", "Dewbauchee Seven-70", "Dinka Blista Compact", "Dinka Blista Compact (Race)", "Dinka Jester", "Dinka Jester (Race)", "Grotti Bestia GTS", "Grotti Carbonizzare", "Hijak Khamelion", "Invetero Coquette", "Karin Futo", "Karin Kuruma", "Karin Kuruma (Armoured)", "Karin Sultan", "Lampadati Furore GT", "Lampadati Tropos Rallye", "Maibatsu Penumbra", "Obey 9F", "Obey 9F Cabrio", "Obey Omnis", "Ocelot Lynx", "Phister Comet", "Schyster Fusilade" };

const std::vector<std::string> VALUES_SPORTS{ "PENUMBRA2", "COQUETTE4", "SUGOI", "VSTR", "SULTAN2", "IMORGON", "KOMODA", "PARAGON", "PARAGON2", "DRAFTER", "ISSI7", "NEO", "JUGULAR", "LOCUST", "SCHLAGEN", "ITALIGTO", "ZR380", "ZR3802", "ZR3803", "JESTER3", "HOTRING", "GB200", "FLASHGT", "SENTINEL3", "STREITER", "REVOLTER", "RAIDEN", "PARIAH", "NEON", "COMET5", "COMET4", "RUSTON", "SPECTER", "SPECTER2", "COMET3", "ALPHA", "ELEGY2", "ELEGY", "FELTZER2", "SCHWARZER", "SURANO", "RAPTOR",  "BANSHEE", "BUFFALO", "BUFFALO2", "BUFFALO3", "VERLIERER2", "TAMPA2", "MASSACRO", "MASSACRO2", "RAPIDGT", "RAPIDGT2", "SEVEN70", "BLISTA2", "BLISTA3", "JESTER", "JESTER2", "BESTIAGTS", "CARBONIZZARE", "KHAMELION", "COQUETTE", "FUTO", "KURUMA", "KURUMA2", "SULTAN", "FUROREGT", "TROPOS", "PENUMBRA", "NINEF", "NINEF2", "OMNIS", "LYNX", "COMET2", "FUSILADE" };

const std::vector<std::string> CAPTIONS_SPORTCLASSICS{ "Vapid Peyote Custom", "Dewbauchee JB 700W", "Vapid Retinue Mk II", "Ubermacht Zion Classic", "Vulcar Nebula Turbo", "Weeny Dynasty", "Ocelot Swinger", "Lampadati Michelli GT", "Vulcar Fagaloa", "Rune Cheburek", "Karin 190z", "Lampadati Viseris", "Ocelot Stromberg", "Annis Savestra", "Grotti GT500", "Imponte Deluxo", "Vapid Retinue", "Dewbauchee Rapid GT Classic", "Pegassi Torero", "Ocelot Ardent", "Grotti Cheetah Classic", "Pegassi Infernus Classic", "Grotti Turismo Classic", "Albany Manana", "Albany Roosevelt 1", "Albany Roosevelt 2", "Benefactor Stirling GT", "Declasse Tornado", "Declasse Tornado (Rusty)", "Declasse Tornado Cabrio", "Declasse Tornado Cabrio (Rusty)", "Declasse Tornado Rat Rod", "Dewbauchee JB 700", "Grotti Stinger", "Grotti Stinger GT", "Invetero Coquette Classic", "Lampadati Casco", "Lampadati Pigalle", "Pegassi Monroe", "Truffade Z-Type", "Vapid Peyote" };

const std::vector<std::string> VALUES_SPORTCLASSICS{ "PEYOTE3", "JB7002", "RETINUE2", "ZION3", "NEBULA", "DYNASTY", "SWINGER", "MICHELLI", "FAGALOA", "CHEBUREK", "Z190", "VISERIS", "STROMBERG", "SAVESTRA", "GT500", "DELUXO", "RETINUE", "RAPIDGT3", "TORERO", "ARDENT", "CHEETAH2", "INFERNUS2", "TURISMO2", "MANANA", "BTYPE", "BTYPE3", "FELTZER3", "TORNADO", "TORNADO3", "TORNADO2", "TORNADO4", "TORNADO6", "JB700", "STINGER", "STINGERGT", "COQUETTE2", "CASCO", "PIGALLE", "MONROE", "ZTYPE", "PEYOTE" };

const std::vector<std::string> CAPTIONS_MUSCLE{ "Albany Manana Custom", "Bravado Gauntlet Classic Custom", "Imponte Beater Dukes", "Declasse Drift Yosemite", "Bravado Gauntlet Classic", "Bravado Gauntlet Hellfire", "Vapid Peyote Gasser", "Declasse Vamos", "Declasse Tulip", "Schyster Deviant", "Vapid Clique", "Apocalypse Slamvan", "Future Shock Slamvan", "Nightmare Slamvan", "Apocalypse Imperator", "Future Shock Imperator", "Nightmare Imperator", "Declasse Impaler", "Apocalypse Impaler", "Future Shock Impaler", "Nightmare Impaler", "Apocalypse Dominator", "Future Shock Dominator", "Nightmare Dominator", "Vapid Ellie", "Vapid Dominator GTX", "Declasse Yosemite", "Vapid Hustler", "Albany Hermes", "Weaponized Tampa", "Ruiner 2000", "Albany Buccaneer", "Albany Franken Strange", "Albany Lurcher", "Albany Virgo", "Bravado Gauntlet", "Bravado Gauntlet (Race)", "Cheval Picador", "Declasse Mamba", "Declasse Tampa", "Declasse Sabre Turbo", "Declasse Stallion", "Declasse Stallion (Race)", "Declasse Vigero", "Declasse Voodoo", "Dundreary Virgo Classic", "Imponte Duke O' Death", "Imponte Dukes", "Imponte Nightshade", "Imponte Phoenix", "Imponte Ruiner", "Invetero Coquette BlackFin", "Vapid Blade", "Vapid Chino", "Vapid Dominator", "Vapid Dominator (Race)", "Vapid Hotknife", "Vapid Slamvan", "Vapid Slamvan (Lost MC)", "Willard Faction" };

const std::vector<std::string> VALUES_MUSCLE{ "MANANA2", "GAUNTLET5", "DUKES3", "YOSEMITE2", "GAUNTLET3", "GAUNTLET4", "PEYOTE2", "VAMOS", "TULIP", "DEVIANT", "CLIQUE", "SLAMVAN4", "SLAMVAN5", "SLAMVAN6", "IMPERATOR", "IMPERATOR2", "IMPERATOR3", "IMPALER", "IMPALER2", "IMPALER3", "IMPALER4", "DOMINATOR4", "DOMINATOR5", "DOMINATOR6", "ELLIE", "DOMINATOR3", "YOSEMITE", "HUSTLER", "HERMES", "TAMPA3", "RUINER2", "BUCCANEER", "BTYPE2", "LURCHER", "VIRGO", "GAUNTLET", "GAUNTLET2", "PICADOR", "MAMBA", "TAMPA", "SABREGT", "STALION", "STALION2", "VIGERO", "VOODOO2", "VIRGO3", "DUKES2", "DUKES", "NIGHTSHADE", "PHOENIX", "RUINER", "COQUETTE3", "BLADE", "CHINO", "DOMINATOR", "DOMINATOR2", "HOTKNIFE", "SLAMVAN", "SLAMVAN2", "FACTION" };

const std::vector<std::string> CAPTIONS_LOWRIDERS{ "Albany Buccaneer", "Albany Primo", "Declasse Moonbeam", "Declasse Sabre Turbo", "Declasse Tornado", "Declasse Voodoo", "Dundreary Virgo Classic", "Vapid Chino", "Vapid Minivan", "Vapid Slamvan", "Willard Faction", "Willard Faction Donk" };

const std::vector<std::string> VALUES_LOWRIDERS{ "BUCCANEER2", "PRIMO2", "MOONBEAM2", "SABREGT2", "TORNADO5", "VOODOO", "VIRGO2", "CHINO2", "MINIVAN2", "SLAMVAN3", "FACTION2", "FACTION3" };

const std::vector<std::string> CAPTIONS_COUPES{ "Dewbauchee Exemplar", "Enus Cognoscenti Cabrio", "Enus Windsor", "Enus Windsor Drop", "Lampadati Felon", "Lampadati Felon GT", "Ocelot F620", "Ocelot Jackal", "Ubermacht Sentinel", "Ubermacht Sentinel XS", "Ubermacht Zion", "Ubermacht Zion Cabrio" };

const std::vector<std::string> VALUES_COUPES{ "EXEMPLAR", "COGCABRIO", "WINDSOR", "WINDSOR2", "FELON", "FELON2", "F620", "JACKAL", "SENTINEL2", "SENTINEL", "ZION", "ZION2" };

const std::vector<std::string> CAPTIONS_SEDANS{ "Benefactor Glendale Custom", "Enus Stafford", "Albany Emperor", "Albany Emperor (Rusty)", "Albany Emperor (Snow)", "Albany Primo", "Albany Washington", "Benefactor Glendale", "Benefactor Schafter", "Chariot Romero Hearse", "Cheval Fugitive", "Cheval Surge", "Declasse Asea", "Declasse Asea (Snow)", "Declasse Premier", "Dundreary Regina", "Dundreary Stretch", "Enus Super Diamond", "Karin Asterope", "Karin Intruder", "Obey Tailgater", "Ubermacht Oracle", "Ubermacht Oracle Mk2", "Vapid Stanier", "Vapid Stanier (Taxi)", "Vulcar Ingot", "Vulcar Warrener", "Zirconium Stratum" };

const std::vector<std::string> VALUES_SEDANS{ "GLENDALE2", "STAFFORD", "EMPEROR", "EMPEROR2", "EMPEROR3", "PRIMO", "WASHINGTON", "GLENDALE", "SCHAFTER2", "ROMERO", "FUGITIVE", "SURGE", "ASEA", "ASEA2", "PREMIER", "REGINA", "STRETCH", "SUPERD", "ASTEROPE", "INTRUDER", "TAILGATER", "ORACLE", "ORACLE2", "STANIER", "TAXI", "INGOT", "WARRENER", "STRATUM" };


const std::vector<std::string> CAPTIONS_COMPACTS{ "BF Club", "Dinka Blista Kanjo", "Maxwell Asbo", "Weeny Issi Classic", "Apocalypse Issi", "Future Shock Issi", "Nightmare Issi", "Benefactor Panto", "Bollokan Prairie", "Declasse Rhapsody", "Dinka Blista", "Grotti Brioso R/A", "Karin Dilettante", "Karin Dilettante (FlyUS)", "Weeny Issi" };

const std::vector<std::string> VALUES_COMPACTS{ "CLUB", "KANJO", "ASBO", "ISSI3", "ISSI4", "ISSI5", "ISSI6", "PANTO", "PRAIRIE", "RHAPSODY", "BLISTA", "BRIOSO", "DILETTANTE", "DILETTANTE2", "ISSI2" };

const std::vector<std::string> CAPTIONS_SUVS{ "Canis Seminole Frontier", "Dundreary Landstalker XL", "Ubermacht Rebla GTS", "Lampadati Novak", "Pegassi Toros", "Mammoth Patriot Stretch", "Albany Cavalcade", "Albany Cavalcade Mk2", "Benefactor Dubsta", "Benefactor Dubsta (Flat Black)", "Benefactor Serrano", "Bravado Gresley", "Canis Mesa", "Canis Mesa (Snow)", "Canis Seminole", "Declasse Granger", "Dundreary Landstalker", "Emperor Habanero", "Enus Huntley S", "Fathom FQ 2", "Gallivanter Baller (Large)", "Gallivanter Baller (Small)", "Karin BeeJay XL", "Mammoth Patriot", "Obey Rocoto", "Vapid Contender", "Vapid Radius" };

const std::vector<std::string> VALUES_SUVS{ "SEMINOLE2", "LANDSTALKER2", "REBLA", "NOVAK", "TOROS", "PATRIOT2", "CAVALCADE", "CAVALCADE2", "DUBSTA", "DUBSTA2", "SERRANO", "GRESLEY", "MESA", "MESA2", "SEMINOLE", "GRANGER", "LANDSTALKER", "HABANERO", "HUNTLEY", "FQ2", "BALLER", "BALLER2", "BJXL", "PATRIOT", "ROCOTO", "CONTENDER", "RADI" };

const std::vector<std::string> CAPTIONS_OFFROAD{ "Declasse Yosemite Rancher", "Nagasaki Outlaw", "RUNE Zhaba", "Maxwell Vagrant", "Karin Everon", "Vapid Caracara 4X4", "Annis Hellion", "RC Bandito", "Apocalypse Sasquatch", "Future Shock Sasquatch", "Nightmare Sasquatch", "Apocalypse Bruiser", "Future Shock Bruiser", "Nightmare Bruiser", "Apocalypse Brutus", "Future Shock Brutus", "Nightmare Brutus", "HVY Menacer", "Canis Freecrawler", "Vapid Caracara", "Vapid Riata", "Canis Kamacho", "Karin Technical Custom", "HVY Nightshark", "HVY Insurgent Pickup Custom", "Dune FAV", "Aqua Blazer", "Aqua Technical", "Ramp Buggy Spoiler", "Ramp Buggy No Spoiler", "Benefactor Dubsta 6x6", "BF Bifta", "BF Injection", "Bravado Dune", "Bravado Duneloader", "Bravado Space Docker", "Canis Bodhi", "Canis Kalahari", "Canis Mesa (Off-Road)", "Cheval Marshall", "Coil Brawler", "Declasse Rancher XL", "Declasse Rancher XL (Snow)", "Insurgent", "Insurgent (Gun Mount)", "Karin Rebel", "Karin Rebel (Rusty)", "Karin Technical", "Nagasaki Blazer", "Nagasaki Blazer (Hot Rod)", "Nagasaki Blazer (Lifeguard)", "Nagasaki Blazer (Street)", "Vapid Desert Raid", "Vapid Guardian", "Vapid Liberator", "Vapid Sandking", "Vapid Sandking XL", "Vapid Trophy Truck" };

const std::vector<std::string> VALUES_OFFROAD{ "YOSEMITE3", "OUTLAW", "ZHABA", "VAGRANT", "EVERON", "CARACARA2", "HELLION", "RCBANDITO", "MONSTER3", "MONSTER4", "MONSTER5", "BRUISER", "BRUISER2", "BRUISER3", "BRUTUS", "BRUTUS2", "BRUTUS3", "MENACER", "FREECRAWLER", "CARACARA", "RIATA", "KAMACHO", "TECHNICAL3", "NIGHTSHARK", "INSURGENT3", "DUNE3", "BLAZER5", "TECHNICAL2", "DUNE4", "DUNE5", "DUBSTA3", "BIFTA", "BFINJECTION", "DUNE", "DLOADER", "DUNE2", "BODHI2", "KALAHARI", "MESA3", "MARSHALL", "BRAWLER", "RANCHERXL", "RANCHERXL2", "INSURGENT2", "INSURGENT", "REBEL2", "REBEL", "TECHNICAL", "BLAZER", "BLAZER3", "BLAZER2", "BLAZER4", "TROPHYTRUCK2", "GUARDIAN", "MONSTER", "SANDKING2", "SANDKING", "TROPHYTRUCK" };
...
const std::vector<std::string> VALUES_VIP{ "SCHAFTER3", "SCHAFTER5", "SCHAFTER4", "SCHAFTER6", "LIMO2", "XLS", "XLS2", "COGNOSCENTI", "COGNOSCENTI2", "COG55", "COG552", "BALLER3", "BALLER5", "BALLER4", "BALLER6" };


const std::vector<std::string> VOV_CAR_CAPTIONS[] = { CAPTIONS_OPENWHEELS, CAPTIONS_SUPERCARS, CAPTIONS_SPORTS, CAPTIONS_SPORTCLASSICS, CAPTIONS_MUSCLE, CAPTIONS_LOWRIDERS, CAPTIONS_COUPES, CAPTIONS_SEDANS, CAPTIONS_COMPACTS, CAPTIONS_SUVS, CAPTIONS_OFFROAD, CAPTIONS_VIP };

const std::vector<std::string> VOV_CAR_VALUES[] = { VALUES_OPENWHEELS, VALUES_SUPERCARS, VALUES_SPORTS, VALUES_SPORTCLASSICS, VALUES_MUSCLE, VALUES_LOWRIDERS, VALUES_COUPES, VALUES_SEDANS, VALUES_COMPACTS, VALUES_SUVS, VALUES_OFFROAD, VALUES_VIP };
...
const std::vector<std::string> CAPTIONS_VANS{ "Bravado Youga Classic 4x4", "Vapid Speedo Custom", "Armoured Boxville", "BF Surfer", "BF Surfer (Rusty)", "Bravado Paradise", "Bravado Rumpo Custom", "Bravado Rumpo (Deludamol)", "Bravado Rumpo (Weazel News)", "Bravado Youga", "Bravado Youga Classic", "Brute Camper", "Brute Pony (Business)", "Brute Pony (Cannibus Shop)", "Brute Taco Van", "Declasse Burrito", "Declasse Burrito (Bug Stars)", "Declasse Burrito (Construction)", "Declasse Burrito (Gang)", "Declasse Burrito (Graphics)", "Declasse Burrito (Snow)", "Declasse Burrito (The Lost)", "Declasse Moonbeam", "Vapid Minivan", "Vapid Speedo", "Vapid Speedo (Clown)", "Zirconium Journey" };

const std::vector<std::string> VALUES_VANS{ "YOUGA3", "SPEEDO4", "BOXVILLE5", "SURFER", "SURFER2", "PARADISE", "RUMPO3", "RUMPO2", "RUMPO", "YOUGA", "YOUGA2", "CAMPER", "PONY", "PONY2", "TACO", "BURRITO3", "BURRITO2", "BURRITO4", "GBURRITO2", "BURRITO", "BURRITO5", "GBURRITO", "MOONBEAM", "MINIVAN", "SPEEDO", "SPEEDO2", "JOURNEY" };

const std::vector<std::string> CAPTIONS_TRUCKS{ "Apocalypse Cerberus", "Future Shock Cerberus", "Nightmare Cerberus", "MTL Pounder Custom", "Maibatsu Mule Custom", "JoBuilt Phantom Custom", "JoBuilt Hauler Custom", "Phantom Wedge", "Brute Boxville (Go Postal)", "Brute Boxville (Humane Labs)", "Brute Boxville (Post OP)", "Brute Boxville (Water & Power)", "Brute Stockade", "Brute Stockade (Snow)", "Brute Tipper (2 Axle)", "Brute Tipper (3 Axle)", "Cutter", "Dock Handler", "Dock Tug", "Dump Truck", "HVY Biff", "Jobuilt Hauler", "Jobuilt Phantom", "Jobuilt Rubble", "Maibatsu Mule (Graphics 1)", "Maibatsu Mule (Graphics 2)", "Maibatsu Mule (Plain)", "Mixer", "Mixer (Support Wheel)", "MTL Flatbed Truck", "MTL Packer", "MTL Pounder", "Vapid Benson", "Vapid Scrap Truck", "Vapid Tow Truck", "Vapid Tow Truck (Old)" };

const std::vector<std::string> VALUES_TRUCKS{ "CERBERUS", "CERBERUS2", "CERBERUS3", "POUNDER2", "MULE4", "PHANTOM3", "HAULER2", "PHANTOM2", "BOXVILLE2", "BOXVILLE3", "BOXVILLE4", "BOXVILLE", "STOCKADE", "STOCKADE3", "TIPTRUCK", "TIPTRUCK2", "CUTTER", "HANDLER", "DOCKTUG", "DUMP", "BIFF", "HAULER", "PHANTOM", "RUBBLE", "MULE", "MULE2", "MULE3", "MIXER", "MIXER2", "FLATBED", "PACKER", "POUNDER", "BENSON", "SCRAP", "TOWTRUCK", "TOWTRUCK2" };

const std::vector<std::string> CAPTIONS_SERVICES{ "Vapid Festival Bus", "Airtug", "Brute Airport Bus", "Brute Bus (City Bus)", "Brute Rental Shuttle Bus", "Brute Tourbus", "Cable Car (Mt. Chilliad)", "Dashound Dashound Coach", "Dozer", "Forklift", "HVY Brickade", "Jobuilt Trashmaster", "Jobuilt Trashmaster (Rusty)", "MTL Dune", "Nagasaki Caddy", "Nagasaki Caddy (Golf)", "Ripley (Airport Tug)", "Stanley Fieldmaster Tractor", "Stanley Fieldmaster Tractor (Snow)", "Stanley Lawn Mower", "Stanley Tractor (Rusty)", "Vapid Pickup Utility", "Vapid Plumbing Utility", "Vapid Telephone Utility" };

const std::vector<std::string> VALUES_SERVICES{ "PBUS2", "AIRTUG", "AIRBUS", "BUS", "RENTALBUS", "TOURBUS", "CABLECAR", "COACH", "BULLDOZER", "FORKLIFT", "BRICKADE", "TRASH2", "TRASH", "RALLYTRUCK", "CADDY2", "CADDY", "RIPLEY", "TRACTOR2", "TRACTOR3", "MOWER", "TRACTOR", "UTILLITRUCK3", "UTILLITRUCK2", "UTILLITRUCK" };

const std::vector<std::string> CAPTIONS_TRAILERS{ "AA Turret Trailer", "Army Flatbed Trailer (Empty)", "Army Flatbed Trailer (With Drill)", "Army Fuel Tanker", "Boat Trailer", "Boat Trailer", "Car Transport Trailer", "Car Transport Trailer (Empty)", "Commercial Trailer (Graphics 1)", "Commercial Trailer (Graphics 2)", "Container Trailer", "Fame or Shame Trailer", "Flatbed Trailer", "Flatbed Trailer", "Grain Trailer", "Hay Bale Trailer", "Logging Trailer", "Meth Lab Trailer", "Petrol Tanker Trailer (Plain)", "Petrol Tanker Trailer (RON)", "Plain Trailer", "Rake Trailer", "Small Trailer" };

const std::vector<std::string> VALUES_TRAILERS{ "TRAILERSMALL2", "ARMYTRAILER", "ARMYTRAILER2", "ARMYTANKER", "BOATTRAILER", "TR3", "TR4", "TR2", "TRAILERS2", "TRAILERS3", "DOCKTRAILER", "TVTRAILER", "FREIGHTTRAILER", "TRFLAT", "GRAINTRAILER", "BALETRAILER", "TRAILERLOGS", "PROPTRAILER", "TANKER2", "TANKER", "TRAILERS", "RAKETRAILER", "TRAILERSMALL" };
...
const std::vector<std::string> CAPTIONS_EMERGENCY{ "Invade and Persuade Tank", "Apocalypse Scarab", "Future Shock Scarab", "Nightmare Scarab", "Benefactor Terrorbyte", "Mammoth Thruster", "RCV", "TM-02 Khanjali", "HVY Chernobog", "HVY Barrage", "HVY APC", "Bravado Halftrack", "Albany Police Roadcruiser (Snow)", "Ambulance", "Army Barracks Truck", "Army Truck Cab", "Bravado Buffalo (FIB)", "Brute Police Riot Van", "Canis Crusader (Army Mesa)", "Declasse Granger (FIB)", "Declasse Lifeguard", "Declasse Park Ranger", "Declasse Police Rancher (Snow)", "Declasse Police Transporter", "Declasse Sheriff SUV", "Firetruck", "Prison Bus", "Rhino Tank", "Vapid Police Buffalo", "Vapid Police Cruiser", "Vapid Police Interceptor", "Vapid Sheriff Cruiser", "Vapid Unmarked Police Cruiser", "Western Police Bike" };

const std::vector<std::string> VALUES_EMERGENCY{ "MINITANK", "SCARAB", "SCARAB2", "SCARAB3", "TERBYTE", "THRUSTER", "RIOT2", "KHANJALI", "CHERNOBOG", "BARRAGE", "APC", "HALFTRACK", "POLICEOLD2", "AMBULANCE", "BARRACKS", "BARRACKS2", "FBI", "RIOT", "CRUSADER", "FBI2", "LGUARD", "PRANGER", "POLICEOLD1", "POLICET", "SHERIFF2", "FIRETRUK", "PBUS", "RHINO", "POLICE2", "POLICE", "POLICE3", "SHERIFF", "POLICE4", "POLICEB" };

const std::vector<std::string> CAPTIONS_MOTORCYCLES{ "Nagasaki Stryder", "Western Rampant Rocket", "Apocalypse Deathbike", "Future Shock Deathbike", "Nightmare Deathbike", "Pegassi Opressor Mk II", "Dinka Akuma", "Dinka Double-T", "Dinka Enduro", "Dinka Thrust", "Dinka Vindicator", "LCC Avarus", "LCC Hexer", "LCC Innovation", "LCC Sanctus", "Maibatsu Manchez", "Maibatsu Sanchez", "Maibatsu Sanchez(Graphics)", "Nagasaki BF400", "Nagasaki Carbon RS", "Nagasaki Chimera", "Nagasaki Shotaro", "Pegassi Bati", "Pegassi Bati(Race)", "Pegassi Esskey", "Pegassi Faggio Mod", "Pegassi Faggio Sport", "Pegassi Ruffian", "Pegassi Vortex", "Principe Lectro", "Principe Nemesis", "Principe Phaggio", "Shitzu Defiler", "Shitzu Hakuchou", "Shitzu Hakuchou Drag", "Shitzu PCJ 600", "Shitzu Vader", "Western Bagger", "Western Cliffhanger", "Western Daemon", "Western Daemon Custom", "Western Gargoyle", "Western Nightblade", "Western Rat Bike", "Western Sovereign", "Western Wolfsbane", "Western Zombie Bobber", "Western Zombie Chopper" };

const std::vector<std::string> VALUES_MOTORCYCLES{ "STRYDER", "RROCKET", "DEATHBIKE", "DEATHBIKE2", "DEATHBIKE3", "OPPRESSOR2", "AKUMA", "DOUBLE", "ENDURO", "THRUST", "VINDICATOR", "AVARUS", "HEXER", "INNOVATION", "SANCTUS", "MANCHEZ", "SANCHEZ2", "SANCHEZ", "BF400", "CARBONRS", "CHIMERA", "SHOTARO", "BATI", "BATI2", "ESSKEY", "FAGGIO3", "FAGGIO", "RUFFIAN", "VORTEX", "LECTRO", "NEMESIS", "FAGGIO2", "DEFILER", "HAKUCHOU", "HAKUCHOU2", "PCJ", "VADER", "BAGGER", "CLIFFHANGER", "DAEMON", "DAEMON2", "GARGOYLE", "NIGHTBLADE", "RATBIKE", "SOVEREIGN", "WOLFSBANE", "ZOMBIEA", "ZOMBIEB" };

const std::vector<std::string> CAPTIONS_PLANES{ "B-11 Strikeforce", "Blimp", "Volatol", "Mammoth Avenger", "Buckingham Cargo Plane (An-225)", "Buckingham Jet (B747)", "Buckingham Luxor", "Buckingham Luxor Deluxe", "Buckingham Miljet", "Buckingham Nimbus", "Buckingham Shamal", "Buckingham Vestra", "Jobuilt Mammatus", "Jobuilt P-996 Lazer", "Jobuilt Velum (4 Seater)", "Jobuilt Velum (5 Seater)", "Mammoth Dodo", "Mammoth Hydra", "Mammoth Titan", "Western Besra", "Western Cuban 800", "Western Duster", "Western Mallard Stunt Plane" };

const std::vector<std::string> VALUES_PLANES{ "STRIKEFORCE", "BLIMP3", "VOLATOL", "AVENGER", "CARGOPLANE", "JET", "LUXOR", "LUXOR2", "MILJET", "NIMBUS", "SHAMAL", "VESTRA", "MAMMATUS", "LAZER", "VELUM", "VELUM2", "DODO", "HYDRA", "TITAN", "BESRA", "CUBAN800", "DUSTER", "STUNT" };

const std::vector<std::string> CAPTIONS_HELOS{ "Sea Sparrow", "Buckingham Akula", "Blimp (Atomic)", "Blimp (Xero Gas)", "Buckingham Savage", "Buckingham SuperVolito", "Buckingham SuperVolito Carbon", "Buckingham Swift", "Buckingham Swift Deluxe", "Buckingham Valkyrie", "Buckingham Volatus", "HVY Skylift", "Maibatsu Frogger", "Maibatsu Frogger (TPE/FIB)", "Nagasaki Buzzard (Unarmed)", "Nagasaki Buzzard Attack Chopper", "Nagasaki Havok", "Western Annihilator", "Western Cargobob (Desert Camo)", "Western Cargobob (Jetsam)", "Western Cargobob (TPE)", "Western Maverick", "Western Maverick (Police)" };

const std::vector<std::string> VALUES_HELOS{ "SEASPARROW", "AKULA", "BLIMP", "BLIMP2", "SAVAGE", "SUPERVOLITO", "SUPERVOLITO2", "SWIFT", "SWIFT2", "VALKYRIE", "VOLATUS", "SKYLIFT", "FROGGER", "FROGGER2", "BUZZARD2", "BUZZARD", "HAVOK", "ANNIHILATOR", "CARGOBOB", "CARGOBOB2", "CARGOBOB3", "MAVERICK", "POLMAV" };

const std::vector<std::string> CAPTIONS_BOATS{ "Buckingham Tug", "Dinka Marquis", "Kraken Sub", "Lampadati Toro", "Nagasaki Dinghy (2 Seater)", "Nagasaki Dinghy (4 Seater, Black)", "Nagasaki Dinghy (4 Seater, Red)", "Pegassi Speeder", "Shitzu Jetmax", "Shitzu Predator (Police)", "Shitzu Squalo", "Shitzu Suntrap", "Shitzu Tropic", "Speedophile Seashark", "Speedophile Seashark (Lifeguard)", "Submersible" };
...
bool onconfirm_vehdoor_menu(MenuItem<int> choice) {
	...
	if (choice.currentMenuIndex == 8)
	{
		if (bPlayerExists && PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0))
		{
			...
			{
				VEHICLE::SET_VEHICLE_DOORS_SHUT(veh, featureVehicleDoorInstant);
			}
		}
		else
		{
...
bool onconfirm_veh_menu(MenuItem<int> choice)
{
		...
		if (featureDriftMode)
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0)){
				...
				if (ENTITY::DOES_ENTITY_EXIST(veh) && !ENTITY::IS_ENTITY_DEAD(veh)){
					if (ENTITY::DOES_ENTITY_EXIST(driver)){
						if (driver == playerPed){
							set_status_text("Drift Mode ~g~ENABLED.~n~~s~Hold <C>~p~SHIFT</C> ~s~To Drift.");
						}
					}
				}
	...
	case 16:
		if (featureVehControls)
		{
			...
			set_status_text("~p~LEFT ~s~& ~p~RIGHT ~s~Arrows control turn signals ~s~");
			set_status_text("~p~UP ~s~& ~p~DOWN ~s~Arrows control front windows");
			set_status_text("~p~CTRL + UP ~s~& ~p~DOWN ~s~Arrows controls back windows");
			set_status_text("~p~NUMPAD DECIMAL ~s~Key controls interior light");
			set_status_text("~p~NUMPAD PLUS ~s~Key toggles police lights");
			set_status_text("~p~NUMPAD MINUS ~s~Key toggles police siren");
			set_status_text("~p~CTRL+NUMPAD7 ~s~Key toggles Front Left Door ");
			set_status_text("~p~CTRL+NUMPAD9 ~s~Key toggles Front Right Door");
			set_status_text("~p~CTRL+NUMPAD4 ~s~Key toggles Back Left Door");
			set_status_text("~p~CTRL+NUMPAD6 ~s~Key toggles Back Right Door");
			set_status_text("~p~CTRL+NUMPAD8 ~s~Key toggles Hood");
			set_status_text("~p~CTRL+NUMPAD5 ~s~Key toggles Trunk");
		}
		else
		{
	...
	if (featureKPH)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0))
		{
			if (PED::IS_PED_IN_FLYING_VEHICLE(playerPed) || PED::IS_PED_IN_ANY_BOAT(playerPed) || PED::IS_PED_IN_ANY_SUB(playerPed))
			{
				...
				char speed_text[50];
				snprintf(speed_text, 50, "kn~p~/~s~kt");
	...
	if (featureKPHMPH)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(playerPed, 0))
		{
			...
			else
			{
				...
				snprintf(speedKph_text, 50, "~p~%.0f", speedKph);
				snprintf(speedMph_text, 50, "%.0f", speedMph);
				...
				snprintf(kphspeed_text, 50, "~p~KPH");
...
bool do_spawn_vehicle(std::string modelName, std::string modelTitle)
{
	...
	preveh = rveh;
	rveh = do_spawn_vehicle(model, modelTitle);
	if (rveh != -1)
	{
		if (featureSpawnDelete)
		{
...
bool spawn_saved_car(int slot, std::string caption)
{
	...
	Ped playerPed = PLAYER::PLAYER_PED_ID();
	preveh = rveh;
	rveh = do_spawn_vehicle(savedVeh->model, caption);
	if (rveh == -1)
	{
